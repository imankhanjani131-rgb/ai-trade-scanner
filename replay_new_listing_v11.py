...
def checkpoint(candles, hour):
    ...
    if hour == 1:
        mom = one_hour_momentum(sample)

        if mom["vol_accel"] >= 1.25:
            score_v11 += 1
...
def main():
    print("NEW LISTING HUNTER V1.1 - REPLAY")
    print("1H volume fix + Momentum Breakout")
    ...
    if passed == 4:
        print(
            ...
            "Next step is a larger unseen sample."
        )
    else:
        print(
